...
function MomentsCta() {
  return (
    <section className="relative overflow-hidden bg-paper py-8 md:py-12">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center px-6">
        <p className="text-ink text-xl md:text-2xl font-light leading-snug mb-5" style={{ fontFamily: "var(--font-heading)" }}>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-moss text-white font-semibold text-sm tracking-wide transition-all duration-300 hover:shadow-[0_10px_40px_rgba(0,138,199,0.45)] hover:-translate-y-0.5"
        >
...
export default function Home() {
  ...
  return (
    <>
      ...
      <WaveSeparator from="#C9F4F6" to="#003B5C" />
    </>
  );
}