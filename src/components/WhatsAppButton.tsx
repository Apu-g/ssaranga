export default function WhatsAppButton() {
  return (
    ...
    >
      {/* Tooltip label */}
      <span className="pointer-events-none translate-x-2 rounded-full bg-deep-forest/90 px-3 py-1.5 text-xs font-medium tracking-wide text-white opacity-0 shadow-lg backdrop-blur transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
        Chat with us
      </span>
